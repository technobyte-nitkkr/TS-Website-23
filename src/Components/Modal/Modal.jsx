    ...
    <div>
      ...
      <div className="modal-container">
        <div className="modal-top">
          <div className="tag">
            <img src="/assets/modal/tag.png" alt="" className="modal-top-img" />
          </div>
          <SearchBox title="mona-github-github-g59jpq2w5w7.github.dev" />
          <div className="tag">
            <img src="/assets/modal/add.png" alt="" className="modal-top-img" />
          </div>
        </div>
        <div className="modal-body">
          <div className="modal-menu">
            ...
            <div
              ...
              style={menuOpen == false ? { width: "0px", padding: "0px" } : {}}
            >
              <div>
                {menuItems?.map((e) => {
                  return (
                    <div onClick={onMenuClick} key={e.label}>
                      {e.label}
                    </div>
                  );
                })}
